...
def back_warp_disp(img, disp, padding_mode='zeros'):
    ...
    warped_img = torch.nn.functional.grid_sample(img, sample_grid, mode='bilinear', padding_mode=padding_mode)

    mask = torch.ones_like(img)
    valid_mask = torch.nn.functional.grid_sample(mask, sample_grid, mode='bilinear', padding_mode='zeros')
